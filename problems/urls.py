...
from . import views, views_admin   # 👈 thêm views_admin vào
...
urlpatterns = [
    ...
    # 💡 Thêm route cho AI gợi ý tag (admin)
    path('ai_suggest_tags/', views_admin.ai_suggest_tags, name='ai_suggest_tags'),  # 👈 dòng này
]
