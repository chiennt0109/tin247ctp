    ...
    "topics": [
        {
            ...
            "html_file": "roadmap_data/topics/stage01_topic01.html",
...
print(a + b)"""
        },
        {
            ...
            "html_file": "roadmap_data/topics/stage01_topic02.html",
            "sample_cpp": """#include <bits/stdc++.h>
using namespace std;
int main() {
    int n;
...
print("Even" if n % 2 == 0 else "Odd")"""
        },
        {
            ...
            "html_file": "roadmap_data/topics/stage01_topic03.html",
            "sample_cpp": """#include <bits/stdc++.h>
using namespace std;
int main() {
    int n, sum = 0;
